...
public class PrivateMessageReactionController {
    ...
    public List<ReactionDTO> getAll(@PathVariable("currentUserId") int currentUserId,
        ...
        return reactionService.getAll(currentUser, privateChat, message, pageable).stream()
    ...
    public List<ReactionDTO> getAllByEmoji(@PathVariable("currentUserId") int currentUserId,
        ...
        return reactionService.getAllByEmoji(currentUser, privateChat, message, emoji, pageable).stream()
                .map(reactionMapper::toDTO)
                .toList();
    }
